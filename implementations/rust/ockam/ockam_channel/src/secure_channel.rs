...
use ockam_core::{
    Address, AllowAll, AllowSourceAddress, DenyAll, LocalDestinationOnly, Mailbox, Mailboxes,
    Result, Route,
};
...
impl SecureChannel {
    ...
    pub async fn create_extended(
        ...
        let address_internal = Address::random_tagged("SecureChannel.initiator.decryptor.internal");
